...
path_in="REMAP_DISCUSS_s.fits"
path_out="REMAP_DISCUSS_s_resid2.fits"
path_out_comp="REMAP_DISCUSS_s_comp2.fits"
#=====================================================
...
x_max=64 #x position of peak
y_max=65 #y position of peak
xo_max=64 #x position of second peak
yo_max=65 #y position of second peak
dx_g=3 #x-deviation of second peak resp. to first peak
dy_g=-3 #y-deviation of second peak resp. to first peak

thet=-30 #position angle of both 2d gauss in deg

amp=2 #Amplitude of max position
ampo=1 #Amplitude of max position
sigm1=0.1 #width of first 1d gauss
sigm2=0.15 #width of first 1d gauss orthogonal
sigm1o=2 #width of second 1d gauss
sigm2o=5 #width of second 1d gauss orthogonal

tval=33./1000000 #Value offset for fit (noise)

#Fitting min-max param values:
#min:
x_max_min=60 #x position of peak
y_max_min=60 #y position of peak
xo_max_min=60 #x position of second peak
yo_max_min=60 #y position of second peak
dx_min=-10 #min x-deviation of second peak resp. to first peak
dy_min=-10 #min y-deviation of second peak resp. to first peak

thet_min=-60 #position angle of both 2d gauss in deg

amp_min=1 #Amplitude of max position
ampo_min=0.001 #Amplitude of max position
sigm1_min=0.01 #width of first 1d gauss
sigm2_min=0.015 #width of second 1d gauss
...
#max:
x_max_max=70 #x position of peak
y_max_max=70 #y position of peak
xo_max_max=70 #x position of second peak
yo_max_max=70 #y position of second peak
dx_max=5 #max x-deviation of second peak resp. to first peak
dy_max=5 #max y-deviation of second peak resp. to first peak


thet_max=-10 #position angle of both 2d gauss in deg

amp_max=5 #Amplitude of max position
ampo_max=1 #Amplitude of max position
sigm1_max=1 #width of first 1d gauss
sigm2_max=1 #width of second 1d gauss
sigm1o_max=10 #width of first 1d gauss
sigm2o_max=10 #width of second 1d gauss

tval_max=0.005 #Maximum-Value offset for fit (noise)
