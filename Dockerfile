...
RUN if [ "${WCSLIB_VERSION}" != "latest" ]; then cd ${INSTALLDIR}/wcslib && wget --retry-connrefused http://www.astro-wise.org/losoft/wcslib-${WCSLIB_VERSION}.tar.bz2; fi
